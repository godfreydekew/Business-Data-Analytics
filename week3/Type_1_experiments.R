...
# Rejecting the null hypothesiss when the null hypothesius is true
#One population
pop <- rnorm(100000, 100, 100)
...
# First we try to standardize using the logistic functions
#if it fails we then use non parametric tests

#The standard deviation is large or small?
# No effect , not sure here 

#The sample size is very small or very large?
# If sample size increase the p value decreases
# This can also make meaningless difference statistically signifcant , (cohen d)
