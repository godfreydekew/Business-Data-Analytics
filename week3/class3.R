...
# Their differences will be centered around zero
...
# We can get the same result if we use SE = SQRT(se1^2+ se2^2)
...
#The $p$-value is defined as the area in the tails (the extreme regions).
